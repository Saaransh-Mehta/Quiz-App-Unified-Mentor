...
import { quizLevelOne } from '../quizData.js'
...
const [currentQuestionIndex,setCurrentQuestionIndex] = useState(0)
    ...
    const allQuestion = quizLevelOne[currentQuestionIndex]
    ...
    const handleSubmit = (e)=>{
        ...
        if(currentQuestionIndex === quizLevelOne.length - 1){
            // alert(`You have completed the level ${quizLevelOne.length} and your score is ${score}`)
  ...
  return (
    ...
    <div className="top m-2 flex gap-3">
        ...
        <div className='flex justify-center items-center mt-10'>
            <h1 className=' text-5xl text-[#f9ae65] bebas-neue '>Level One</h1>
        </div>
    </div>
    <div className='grid grid-cols-1 mt-5'>
        <div className='flex justify-center items-center'>
            ...
            <div className='h-[400px] w-[700px] border border-[#f9ae65]'>
                ...
                <h1 className=' text-2xl mt-1 text-[#E0E2EE] ml-[7.5rem] bebas-neue '>{`Question number : ${currentQuestionIndex + 1}`}</h1>
